...
const useClapState = (initialState = Initial_State) => {
    ...
    const resetClapState = useCallback(() => {
        setClapState({ ...Initial_State });
    }, [ ]);
...
const Usage = () => {
    const { clapState, getTogglerProps, getCounterProps } = useClapState(Initial_State)
    ...
    const handleClapClick = () => {
        console.log({ count, countTotal, isClicked });
    }
    return <ClapContainer {...getTogglerProps({
